...
The R package scpoissonmodel is developed to visualize the Poissoneity of scRNA-seq data, and explore cell clustering based on departure as a novel data representation.
